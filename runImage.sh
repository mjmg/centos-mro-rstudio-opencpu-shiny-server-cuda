...
sudo nvidia-docker run -p 80:80 -p 443:443 --name centos-mro-rstudio-opencpu-shiny-server-cuda -v /home/mjg/Shared/shiny:/home/shiny:rw,z -ti mjmg/centos-mro-rstudio-opencpu-shiny-server-cuda
